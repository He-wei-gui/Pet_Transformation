...
// 为某个 openid 签发 30 天 token（鸿蒙账号密码登录复用）
...
// 鸿蒙端账号密码注册：POST /auth/register {username, password, nickname?}
// 与微信登录互不影响——鸿蒙用户 openid 用 hm_ 前缀，username/password_hash 对微信用户保留 NULL。
...
// 鸿蒙端账号密码登录：POST /auth/login-app {username, password}
